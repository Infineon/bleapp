...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x00000003u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG4), 0xA0000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG4), 0x00A00000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x00030000u);

		/* TCPWM_CNT0 Starting address: CYDEV_TCPWM_CNT0_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT0_TR_CTRL0), 0x000A0060u);

		/* TCPWM_CNT3 Starting address: CYDEV_TCPWM_CNT3_TR_CTRL0 */
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT3_TR_CTRL0), 0x000E00F0u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000014u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00276D80u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000021u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00036276u);
