...
*   Values:
*     - QDLEFT_CMD_CAPTURE    - Trigger Capture command
*     - QDLEFT_CMD_RELOAD     - Trigger Reload command
*     - QDLEFT_CMD_STOP       - Trigger Stop command
*     - QDLEFT_CMD_START      - Trigger Start command
*
* Return:
*  None
*
